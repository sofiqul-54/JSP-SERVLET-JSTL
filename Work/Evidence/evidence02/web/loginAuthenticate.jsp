<%-- 
    ...
    Created on : Dec 24, 2018, 9:31:56 AM
    Author     : User
--%>
    ...
    <body>       
        <c:if test="${empty param.username or empty param.password}">
            <c:redirect url="login.jsp">
                <c:param name="errMsg" value="Please Enter Valid Username & Password"/>
            </c:redirect>
        </c:if>
        <c:if test="${not empty parm.username and not empty param.password}">
